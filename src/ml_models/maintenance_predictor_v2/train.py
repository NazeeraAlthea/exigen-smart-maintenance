...
def main():
    ...
    mlflow.set_experiment("Maintenance_Predictor_RUL_Pure_v2")
    ...
    with mlflow.start_run():
        ...
        mlflow.log_params({"model": "XGBRegressor_v2", "target_filtering": True, "outlier_removal": "IQR", "leak_free": True, "pipeline_cv": True})
        ...
        joblib.dump(model_pipeline, 'models/maintenance_predictor_v2_xgb.pkl')
        print("\nModel pipeline PURE RUL berhasil di-save ke: models/maintenance_predictor_v2_xgb.pkl")
